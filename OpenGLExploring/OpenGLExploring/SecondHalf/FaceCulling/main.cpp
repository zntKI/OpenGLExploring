...
#pragma region SetUp
	...
	window = glfwCreateWindow( windowWidth, windowHeight, "Face culling", NULL, NULL );
	if ( !window )
	{
		glfwTerminate();
		return -1;
...
#pragma region ShaderGen
	...
	Shader ourShader( "SecondHalf/FaceCulling/vertexShader.glsl", "SecondHalf/FaceCulling/fragmentShader.glsl" );
